...
$query = "SELECT altitude,time FROM 2_entry_exit_control
ORDER BY id DESC 
LIMIT 0,10"; 
...
<nav class="navbar navbar-light bg-white">
    <a class="navbar-brand" href="https://www.instagram.com/dhanuzch/" target="_blank">
        <img src="C:\Users\Dhanuzch\Desktop\Assam_hack\2_Tracker for Forest road\Website\img\logo.png" width="50" height="50" class="d-inline-block align-top" alt="">
...
<div class="w3-col l8 s12">
  ...
  <div class="w3-card-4 w3-margin w3-white">
    ...
    <div class="w3-container">
      <div class="box1">
        <img src="C:\Users\Dhanuzch\Desktop\Assam_hack\2_Tracker for Forest road\Website\img\bg.jpg" alt="Nature" style="width:100%">
          <div class="text1">
              <h5>Flying Kites</h5>
          </div>
          <div class="text2">
  ...
  <div class="w3-card w3-margin w3-margin-top">
    ...
    <div class="w3-container w3-white">
      ...
      <table class="w3-table-all w3-hoverable">
        ...
        { 
        ?> 
        <tr> <td><?php echo $rows['registration_no']; ?></td> 
        <td><?php echo $rows['brand']; ?> <?php echo $rows['model']; ?></td> 
...
<style>
    ...
    .box1 .text3{
        ...
        left: 67%;
        right: 0;        
        top: 72%; /* Adjust this value to move the positioned div up and down */
        font-family: Arial,sans-serif;
        color: #000000;
        width: 60%; /* Set the width of the positioned div */
    }
