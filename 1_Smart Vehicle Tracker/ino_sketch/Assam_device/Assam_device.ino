...
const char* ssid = "HOT_SPOT_NAME";   //replace this with ssid of hotspot (comment this if using GPRS)
const char* password = "HOT_SPOT_PASSWORD";      //replace this with password of hotspot (comment this if using GPRS)

char server[] = "192.168.0.105";    // change the ip address accordingly...if using ngrock use that address
